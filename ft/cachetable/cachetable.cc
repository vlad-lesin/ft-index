    ...
    pair_list *list)
{
    ...
    toku_cond_init(*cachetable_p_refcount_wait_key, &p->refcount_wait,
                   nullptr);
    p->checkpoint_pending = false;
    ...
    nb_mutex_init(*cachetable_disk_nb_mutex_key, *cachetable_disk_nb_rwlock_key,
                  &p->disk_nb_mutex);
...
void pair_list::init() {
    ...
    toku_pthread_rwlock_init(*cachetable_m_pending_lock_expensive_key,
                             &m_pending_lock_expensive, &attr);
    toku_pthread_rwlock_init(*cachetable_m_pending_lock_cheap_key,
    ...
    for (uint64_t i = 0; i < m_num_locks; i++) {
        toku_mutex_init(
            ...
            *cachetable_m_mutex_key,
            ...
            toku_uninstrumented,
#endif
            &m_mutexes[i].aligned_mutex, nullptr);
    }
}
