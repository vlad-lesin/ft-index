...
test_evictions (void) {
    ...
    myargs[0].fwd = true;
    {
        int chk_r = toku_pthread_create(
            toku_uninstrumented, &mytids[0], NULL, scan_db, &myargs[0]);
        CKERR(chk_r);
    }
    ...
    {
        int chk_r = toku_pthread_create(
            toku_uninstrumented, &mytids[1], NULL, scan_db, &myargs[1]);
        CKERR(chk_r);
    }
    ...
    {
        int chk_r = toku_pthread_create(
            toku_uninstrumented, &mytids[2], NULL, scan_db, &myargs[2]);
        CKERR(chk_r);
    }
    ...
    {
        int chk_r = toku_pthread_create(
            toku_uninstrumented, &mytids[3], NULL, scan_db, &myargs[3]);
        CKERR(chk_r);
    }
    ...
    {
        int chk_r = toku_pthread_create(
            toku_uninstrumented, &mytids[4], NULL, update_db, &myargs[4]);
        CKERR(chk_r);
    }
    ...
    {
        int chk_r = toku_pthread_create(
            toku_uninstrumented, &mytids[5], NULL, ptquery_db, &myargs[5]);
        CKERR(chk_r);
    }
    ...
    {
        int chk_r = toku_pthread_create(
            toku_uninstrumented, &mytids[6], NULL, test_time, NULL);
        CKERR(chk_r);
    }
